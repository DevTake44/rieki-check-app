...
// 何回かに分けて呼び出す。
//
// 2026-09-04変更(5000→10000→5000): 呼び出し側(ProfitDashboardLoader.tsxの
// LINES_CHUNK_SIZE)と合わせて一度10,000に上げたが、10,000件だと1回目の
// チャンクは成功するのに2回目以降が発生しない不具合が複数回再現したため、
// 実績のある5,000件に戻した(詳細はProfitDashboardLoader.tsx側のコメント参照)。
